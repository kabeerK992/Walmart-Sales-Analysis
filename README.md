...
Walmart-Sales-Analysis/
│
├── walmart_raw.csv                          # Original dataset from Kaggle (unprocessed)
├── clean_walmart.csv                        # Cleaned dataset after Python processing — 9,969 records
├── Walmart_project.ipynb                    # Python EDA notebook — cleaning, analysis, visualisations
├── SQL_Walmart.sql                          # 10 business queries with commentary
├── Walmart_Sales_Dashboard.pbix             # Power BI interactive dashboard
├── Walmart_Dashboard.png                    # Dashboard screenshot
├── Walmart_Sales_Analysis_presentation.pdf  # Full presentation deck — 9 slides
└── README.md
```
