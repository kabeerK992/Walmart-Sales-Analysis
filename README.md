...
> Power BI dashboard with interactive filters by year, category, branch, and payment method.

**All Years Overview**
![Dashboard — All Years](assets/dashboard_all_years.png)

**2019 — Peak Year (before the revenue collapse)**
![Dashboard — 2019](assets/dashboard_2019.png)

**Category-Level View**
![Dashboard — Category Filter](assets/dashboard_category.png)

> 📥 [Download Presentation PDF](assets/Walmart_Sales_Analysis.pdf)  
...
│
├── assets/
│   ├── dashboard_all_years.png             # Dashboard — all years view
│   ├── dashboard_2019.png                  # Dashboard — 2019 peak year
│   ├── dashboard_category.png              # Dashboard — category filter view
│   └── Walmart_Sales_Analysis.pdf          # Full presentation deck
│
└── README.md
```
...
jupyter notebook notebooks/Walmart_project.ipynb
```
...
psql -U your_user -d your_db \
  -c "\copy walmart FROM 'data/clean_walmart.csv' CSV HEADER"

# Run queries
psql -U your_user -d your_db -f sql/SQL_Walmart.sql
```

**Power BI**
```
Open dashboard/Walmart_Sales_Dashboard.pbix in Power BI Desktop.
Data loads automatically from the CSV — update the source path in
Power Query if the file is in a different location.
```
